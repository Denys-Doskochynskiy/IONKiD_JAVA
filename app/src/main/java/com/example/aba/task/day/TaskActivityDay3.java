...
import com.example.aba.comment.days.TestComment3;
...
public class TaskActivityDay3 extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref3 = db3.getInstance().getReference().child("users/"+ UserDetails.username+"/kids/").child(UserDetails.kidName).child("tasks/tasksOfWednesday");
    ...
    protected void onPause(){
        ...
        SharedPreferences sharedPref = getPreferences(Context.MODE_PRIVATE);
        SharedPreferences.Editor editor1 = sharedPref.edit();
        editor1.putInt(FUELBAR, pb31.getProgress());
        editor1.commit();
    ...
    public void onResume(){
        super.onResume();
        pb31 = (ProgressBar) findViewById(R.id.pb31);
        SharedPreferences sharedPref = getPreferences(Context.MODE_PRIVATE);
        incFuel = sharedPref.getInt(FUELBAR, 0);
        pb31.setProgress(incFuel);
    }
