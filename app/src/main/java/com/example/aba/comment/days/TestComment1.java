...
public class TestComment1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff = FirebaseDatabase.getInstance().getReference().child("users/"+ UserDetails.username+"/kids/").child(UserDetails.kidName).child("tasks/tasksOfMonday/comment");
        comment = new Comment();
        btnAdd.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TestComment1.this,"comment was sent",Toast.LENGTH_LONG).show();
            }
