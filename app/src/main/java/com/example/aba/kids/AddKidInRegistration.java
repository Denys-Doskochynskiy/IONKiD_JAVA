...
public class AddKidInRegistration extends Activity {
    Button addKid;
        ...
        addKid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firstNameKid.equals("")) {
                    ...
                    final ProgressDialog pd = new ProgressDialog(AddKidInRegistration.this);
                    ...
                    StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String s) {
                            ...
                            if (s.equals("null")) {
                                ...
                                Toast.makeText(AddKidInRegistration.this, "registration successful", Toast.LENGTH_LONG).show();
                                startActivity(new Intent(AddKidInRegistration.this, Login.class));
                            } else {
                                try {
                                    ...
                                    if (!obj.has(lastNameKid)) {
                                        ...
                                        Toast.makeText(AddKidInRegistration.this, "username already exists", Toast.LENGTH_LONG).show();
                                    }
                    ...
                    RequestQueue rQueue = Volley.newRequestQueue(AddKidInRegistration.this);
                    rQueue.add(request);
                }
